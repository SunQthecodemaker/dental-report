  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        ...
        { key: 'spaceUpper',        label: '공간평가 — 상악',   type: 'radio',    options: ['총생(치아 자리 부족)', '공간(치아 사이 벌어짐)'], severe: true },
        { key: 'spaceLower',        label: '공간평가 — 하악',   type: 'radio',    options: ['총생(치아 자리 부족)', '공간(치아 사이 벌어짐)'], severe: true },
