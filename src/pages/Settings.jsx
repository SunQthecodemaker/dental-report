...
const ABSOLUTE_RULES = [
  ...
  },
  {
    ...
    body: [
      ...
      '문제 목록은 <ul><li> bullet, 한 항목 한 줄 (의미 담긴 자연 문장 — 단순 키워드 나열 금지)',
      '치료 계획·종합 안내는 <p>문단</p>',
  ...
  },
  {
    ...
    body: [
      ...
      '[체크5] "추가 사항"/"치성 관계"/"골격 관계" 같은 메타·옛 라벨이 본문에 남지 않았는가?',
      '[체크6] 출력에 "#숫자"가 그대로 남아있지 않은가?',
      '[체크7] 성향 라벨(꼼꼼·바쁨·감성 등)이 본문/personalNote에 노출되지 않았는가?',
      '[체크8] 문제 목록이 단순 키워드 나열이 아닌 의미 담긴 한 줄 문장인가?',
      '[체크9] 종합 안내가 단순 항목 반복이 아닌 연결된 산문인가?',
